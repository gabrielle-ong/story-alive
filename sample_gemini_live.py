...
class GeminiLive:
    ...
    async def start_session(self, audio_input_queue, video_input_queue, text_input_queue, audio_output_callback, audio_interrupt_callback=None):
        config = types.LiveConnectConfig(
            ...
            system_instruction=types.Content(parts=[types.Part(text="You are a helpful AI assistant creating a storybook experience. Listen to the user's story or prompt and ALWAYS use the 'generate_storybook_image' tool to create illustrations for the story as they speak. Describe the visual prompt based on the user's input. Speak in a friendly Irish accent.")]),
